...
/**
 * This class performs unit tests on the <code>Base02Utils</code> class.
 *
 * @author Derk Norton
 */
public class Base02UtilsTest {

    static private final XLogger logger = XLoggerFactory.getXLogger(Base02UtilsTest.class);
    ...
    public static void setUpClass() {
        logger.info("Running Base02Utils Unit Tests...\n");
    }
    ...
    public static void tearDownClass() {
        logger.info("Completed Base02Utils Unit Tests.\n");
    }
    ...
    public void testDifferentNumberOfBytes() {
        ...
        String encoded = Base02Utils.encode(bytes);
        byte[] decoded = Base02Utils.decode(encoded);
        ...
        for (int b = -128; b < 128; b++) {
            bytes[0] = (byte) b;
            encoded = Base02Utils.encode(bytes);
            decoded = Base02Utils.decode(encoded);
            assertTrue(Arrays.equals(decoded, bytes));
        }
    ...
    public void testWrapping() {
        ...
        byte[] bytes = RandomUtils.generateRandomBytes(10);
        String encoded = Base02Utils.encode(bytes);
