...
/**
 * This class performs unit tests on the <code>Base16Utils</code> class.
 *
 * @author Derk Norton
 */
public class Base16UtilsTest {

    static private final XLogger logger = XLoggerFactory.getXLogger(Base16UtilsTest.class);
    ...
    public static void setUpClass() {
        logger.info("Running Base16Utils Unit Tests...\n");
    }
    ...
    public static void tearDownClass() {
        logger.info("Completed Base16Utils Unit Tests.\n");
    }
    ...
    public void testDifferentNumberOfBytes() {
        ...
        String encoded = Base16Utils.encode(bytes);
        byte[] decoded = Base16Utils.decode(encoded);
        ...
        for (int b = -128; b < 128; b++) {
            ...
            decoded = Base16Utils.decode(encoded);
            assertTrue(Arrays.equals(decoded, bytes));
        }
    ...
    public void testWrapping() {
        ...
        byte[] bytes = RandomUtils.generateRandomBytes(40);
        String encoded = Base16Utils.encode(bytes);
