...
/**
 * This class performs unit tests on the <code>Base64Utils</code> class.
 *
 * @author Derk Norton
 */
public class Base64UtilsTest {

    static private final XLogger logger = XLoggerFactory.getXLogger(Base64UtilsTest.class);
    ...
    public static void setUpClass() {
        logger.info("Running Base64Utils Unit Tests...\n");
    }
    ...
    public static void tearDownClass() {
        logger.info("Completed Base64Utils Unit Tests.\n");
    }
    ...
    public void testDifferentNumberOfBytes() {
        ...
        assertTrue(ByteUtils.equals(decoded, bytes));
